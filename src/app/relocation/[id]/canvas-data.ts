...
export async function loadRelocationCanvasData(
  ...
  const { data: fRows } = await supabase
    ...
    .select(
      'id, closure_type, seq_no, name, install_address, closure_spec, parent_facility_id, is_marked, notes, x_hint, y_hint, lat, lng, work_window_start, work_window_end, created_at',
    )
