...
export const SCENARIOS: Scenario[] = [
  ...
  {
    slug: 'leave-request',
    title: '휴가 신청 — 대무자 지정과 결재 흐름',
    oneLiner: '연차·반차·병가를 모바일에서 신청 + 결재 진행 상황 확인. (외근은 「외근·차량」 탭)',
    estMinutesMin: 5,
    estMinutesMax: 8,
    permissions: [],
    workTypes: [],
  ...
  {
    slug: 'vehicle',
    title: '외근·차량 — 외근 시작·도착과 차계부',
    oneLiner: '목적·장소·이동수단(업무용/자차/기타)·동행인 적고 출발, 도착 후 km·주유 기록. 차량별 차계부.',
    estMinutesMin: 3,
    estMinutesMax: 5,
    permissions: [],
    workTypes: [],
    routes: ['/trips', '/trips/new', '/vehicles'],
    lastReviewed: '2026-09-20',
  },
  {
    slug: 'daily-report',
